...
export default function Dashboard() {
    ...
    }, [dashData?.subscriber?.count, dashData?.visits?.bounce, dashData?.visits?.general]);
        ...
        <div className="grid">
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Draft Post</span>
                            <div className="text-900 font-medium text-xl">
                    ...
                    <span className="text-green-500 font-medium">Oldest Draft Update</span>
                    <br />
                    <span className="text-500">{dashData?.post_last?.oldest?.updated_at}</span>
                </div>
            </div>
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Web Visitor</span>
                            <div className="text-900 font-medium text-xl">
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Mail Subscriber</span>
                            <div className="text-900 font-medium text-xl">
